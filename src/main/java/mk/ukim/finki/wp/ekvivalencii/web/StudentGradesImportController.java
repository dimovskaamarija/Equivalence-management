...
import static mk.ukim.finki.wp.ekvivalencii.service.specifications.FieldFilterSpecification.*;
...
public class StudentGradesImportController {
    ...
    @GetMapping("/ekvivalencii/{id}/add")
    ...
    @PostMapping("/ekvivalencii/{id}/save")
    public String addStudentGrade(@PathVariable String id,
        ...
        return "redirect:/ekvivalencii/{id}";
    }
    ...
    @PostMapping("/ekvivalencii/{id}/import")
    ...
    @GetMapping("/ekvivalencii/{id}/sample-tsv")
    ...
    @GetMapping("/ekvivalencii/{id}/export")
